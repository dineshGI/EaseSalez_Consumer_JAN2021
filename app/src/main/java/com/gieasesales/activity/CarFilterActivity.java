...
public class CarFilterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.carfilter_activity);
    ...
    private void upaddress(double lat, double lng) {
        String address = Util.getAddress(lat, lng, CarFilterActivity.this);
                        ...
                        if (resobject.getString("Status").equalsIgnoreCase("0")) {
                            ...
                            if (_lstManufacturer.length() > 0) {
                                ...
                                if (ListCollection.size() > 0) {
                                    adapter = new MakeAdapter(CarFilterActivity.this, ListCollection);
                            ...
                            makelistView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                    ...
                                    if (!Make.contains(ListCollection.get(position).get("Manufacturer"))) {
                                        ...
                                        //  Toast.makeText(CarFilterActivity.this, "Added :" + ListCollection.get(position).get("Manufacturer"), Toast.LENGTH_SHORT).show();
                                    } else {
                                        Make.remove(ListCollection.get(position).get("Manufacturer"));
                                        //   Toast.makeText(CarFilterActivity.this, "Removed :" + ListCollection.get(position).get("Manufacturer"), Toast.LENGTH_SHORT).show();
                                    }
                            ...
                            if (_lstFuelType.length() > 0) {
                                ...
                                for (int i = 0; i < _lstFuelType.length(); i++) {
                                    ...
                                    final CheckBox geekBox = new CheckBox(CarFilterActivity.this);
    ...
    private void ButtonClick() {
        Changelocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (CarFilterActivity.this.getPackageName().equals("com.gieasesales")) {
                    Intent locationnew = new Intent(CarFilterActivity.this, PickLocation.class);
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        ...
                        if (resobject.getString("Status").equalsIgnoreCase("0")) {
                            ...
                            if (CarFilterActivity.this.getPackageName().equals("com.gieasesales")) {
                                Intent search = new Intent(CarFilterActivity.this, CarBikeSearch.class);
                                search.putExtra("Data", resobject.toString());
                                search.putExtra("POSTypeId", "20");
    ...
    private void buildAlertMessageNoGps() {
        final AlertDialog.Builder builder = new AlertDialog.Builder(CarFilterActivity.this, R.style.alertDialog);
    ...
    public void onClick(View v) {
        ...
        Hatchback.setImageDrawable(getResources().getDrawable(R.drawable.hatchback));
        ...
        Convertable.setImageDrawable(getResources().getDrawable(R.drawable.convertable));
        Couple.setImageDrawable(getResources().getDrawable(R.drawable.couple));
        Truck.setImageDrawable(getResources().getDrawable(R.drawable.truck));
        Vintage.setImageDrawable(getResources().getDrawable(R.drawable.vintage));
        ...
        switch (v.getId()) {
            ...
            case R.id.SUV:
                ...
                break;
            case R.id.Hatchback:
                Hatchback.setImageDrawable(getResources().getDrawable(R.drawable.hatchback_red));
                Bodytype = "Hatchback";
                break;
            case R.id.Sedan:
                Sedan.setImageDrawable(getResources().getDrawable(R.drawable.sedan_red));
                Bodytype = "Sedan";
                break;
            case R.id.Micro:
                Micro.setImageDrawable(getResources().getDrawable(R.drawable.micro_red));
                Bodytype = "Micro";
                break;
            case R.id.Convertable:
                Convertable.setImageDrawable(getResources().getDrawable(R.drawable.convertable_red));
                Bodytype = "Convertable";
                break;
            case R.id.Couple:
                Couple.setImageDrawable(getResources().getDrawable(R.drawable.couple_red));
                Bodytype = "Coupe";
                break;
            case R.id.Truck:
                Truck.setImageDrawable(getResources().getDrawable(R.drawable.truck_red));
                Bodytype = "Truck and Mini van";
                break;
            case R.id.Vintage:
                Vintage.setImageDrawable(getResources().getDrawable(R.drawable.vintage_red));
                Bodytype = "Vintage";
                break;
