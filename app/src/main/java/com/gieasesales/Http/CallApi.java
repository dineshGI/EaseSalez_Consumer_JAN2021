...
import static com.gieasesales.utils.Util.MOBILE_API;
...
public class CallApi {
    ...
    public static void postResponse(final Context context, String mObject, final String Api, final VolleyResponseListener listener) throws JSONException {
            ...
            JsonObjectRequest req = new JsonObjectRequest(Request.Method.POST, Api, new JSONObject(mObject),
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    if (error.toString().contains("TimeoutError")) {
                        Util.ErrorLog(context, Api.replace(MOBILE_API, "") +":"+ context.getString(R.string.timeout_error));
                    } else {
                        Util.ErrorLog(context, Api.replace(MOBILE_API, "") + context.getString(R.string.server_error));
                    }
    ...
    public static void postResponseNopgrss(final Context context, String mObject, String Api, final VolleyResponseListener listener) throws JSONException {
        ...
        req.setRetryPolicy(new DefaultRetryPolicy(25000,
                0,
                DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
